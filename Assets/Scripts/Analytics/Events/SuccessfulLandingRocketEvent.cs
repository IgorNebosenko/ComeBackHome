...
{
    public class SuccessfulLandingRocketEvent : AnalyticsEvent
    {
        public override string Key => "successful_landing_ rocket";
        
        public SuccessfulLandingRocketEvent(int levelId, int maxOpenedLevel, float flyTime, int countBoostButtonPressed,
